# OpsManager Field Equipment App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-opsmanager-fieldequipment.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-opsmanager-fieldequipment)

This repository contains the source code for the [OpsManager Field Equipment](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.opsmanager.fieldequipment).

Please see the [issues](https://github.com.opsmanager.fieldequipment/com-opsmanager-fieldequipment/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about OpsManager Field Equipment? Ask away on the [com-opsmanager-fieldequipment discussion forum](https://groups.google.com/forum/#!forum/com-opsmanager-fieldequipment).

<a href="https://play.google.com/store/apps/details?id=com.opsmanager.fieldequipment" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.opsmanager.fieldequipment__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.opsmanager.fieldequipment__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.opsmanager.fieldequipment.R__) will now be renamed
...
signed with a different key.  Manually uninstall OpsManager Field Equipment from your device and
...
OpsManager Field Equipment is a result of a template project I've developed over the years as well as
...
OpsManager Field Equipment is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.opsmanager.fieldequipment/com-opsmanager-fieldequipment/contributors) on
...
[pull requests](https://github.com.opsmanager.fieldequipment/com-opsmanager-fieldequipment/pulls).
