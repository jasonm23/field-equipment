...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.opsmanager.fieldequipment";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "OpsManager Field Equipment";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.opsmanager.fieldequipment.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.opsmanager.fieldequipment.";
